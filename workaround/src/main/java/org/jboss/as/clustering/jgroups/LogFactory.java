...
/**
 * Temporary workaround for JGRP-1475 and JGroups API changes.
 *
 * @author Paul Ferraro
 * @author Ales Justin
 */
public class LogFactory implements CustomLogFactory {
    ...
    private static class LogAdapter implements Log {
        ...
        public void fatal(String s, Object... objects) {
            this.logger.fatalv(s, objects);
        }

        @Override
        public void error(String s, Object... objects) {
            this.logger.errorv(s, objects);
        }

        @Override
        public void warn(String s, Object... objects) {
            this.logger.warnv(s, objects);
        }

        @Override
        public void info(String s, Object... objects) {
            this.logger.infov(s, objects);
        }

        @Override
        public void debug(String s, Object... objects) {
            this.logger.debugv(s, objects);
        }

        @Override
        public void trace(String s, Object... objects) {
            this.logger.tracev(s, objects);
        }
    }
}
